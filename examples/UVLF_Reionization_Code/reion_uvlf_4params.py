...
def log_likelihood(lsum, ldiff, l2, l3):
    """
    ...
    ### fixed paramters
    asum,adiff,log10_fesc10, alpha_esc,log10Mcrit  =  9.4376e-01,2.8934e-01,-8.1220e-01,-7.8249e-02,1.0174e+01
...
param_latex_name_arr = [r'\ell_{\varepsilon,0} + \dfrac{\ell_{\varepsilon,\mathrm{jump}}}{2}', 
                        r'\ell_{\varepsilon,0} - \dfrac{\ell_{\varepsilon,\mathrm{jump}}}{2}',
                        r'z_\ast',
                        r'\Delta z_\ast']##,r'\alpha_0 + \dfrac{\alpha_\mathrm{jump}}{2}',r'\alpha_0 - \dfrac{\alpha_\mathrm{jump}}{2}',r'\log_{10}~(\varepsilon_{\mathrm{esc,10}})',r'\alpha_{esc}',r'\log_{10}~M_{\mathrm{crit}}']
...
# fsum,fdiff,f2,f3,asum,adiff,log10_fesc10, alpha_esc,log10Mcrit  = -4.8750e-01,-8.8095e-01,1.0735e+01,1.2034e+00,9.4376e-01,2.8934e-01,-8.1220e-01,-7.8249e-02,1.0174e+01
fsum,fdiff,f2,f3  = -4.8750e-01,-8.8095e-01,1.0735e+01,1.2034e+00
print(log_likelihood(fsum,fdiff,f2,f3))##,asum,adiff, log10_fesc10, alpha_esc, log10Mcrit)) 

#Returns : (-26.619831961022346, {'tau_e': 0.0532452021880309, 'twolone': 0.39345, 'twoaone': 0.65442, 'l0': -0.684225, 'l1': 0.196725, 'a0': 0.61655, 'a1': 0.32721})
